<div class="p-12">
    <form wire:submit.prevent="saveMake" class="space-y-4">
        ...
        <div>
            ...
            <x-text-input wire:model.live="country" id="country" class="block w-full mt-1" type="text"
        ...
        <div>
            ...
            <!-- Changed from x-textarea to standard textarea -->
        ...
        <div class="flex items-center justify-end mt-4">
            <x-secondary-button wire:click="resetForm" wire:loading.attr="disabled" class="mr-3">
                Cancel
            </x-secondary-button>

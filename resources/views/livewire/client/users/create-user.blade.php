<div>
    ...
    @if (session()->has('error'))
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"
            class="fixed z-50 max-w-sm px-4 py-3 text-red-700 bg-red-100 border border-red-400 rounded shadow-lg top-4 right-4"
            role="alert">
            <div class="flex items-center justify-between">
                ...
                <div class="p-8 text-gray-900">
                    <form class="space-y-6" wire:submit.prevent="register">
                        ...
                        <div>
                            ...
                            <x-gold-text-input type="text" wire:model.live.debounce.300ms="name" id="name"
                                required autofocus />
                        ...
                        <div>
                            ...
                            <x-gold-text-input type="text" wire:model.live.debounce.300ms="phone" id="phone"
                                required />
                        ...
                        <div>
                            ...
                            <x-gold-text-input type="password" wire:model.live.debounce.300ms="password" id="password"
                                required />
